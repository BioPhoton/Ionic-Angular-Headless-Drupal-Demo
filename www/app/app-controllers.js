...
appControllers.controller('AppCtrl', ['$rootScope', '$scope', '$cordovaNetwork', 'UserResourceChannel', 'UserResource', 'accessControlConfig', 'drupalApiConfig', '$ionicPlatform', '$state',
                             function ($rootScope,   $scope,   $cordovaNetwork,   UserResourceChannel,   UserResource,   accessControlConfig,   drupalApiConfig,   $ionicPlatform,   $state ) {
