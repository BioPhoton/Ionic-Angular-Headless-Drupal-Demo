...
appControllers.controller('AppCtrl', ['$rootScope', '$scope', 'drupalApiNotificationChannel', 'AppSettings', 'drupalApiServiceConfig', 'DrupalAuthenticationService', 'UserResource', '$ionicPlatform', '$localstorage', '$state',
                             function ($rootScope,   $scope,   drupalApiNotificationChannel,   AppSettings,   drupalApiServiceConfig,   DrupalAuthenticationService,   UserResource,   $ionicPlatform,   $localstorage,   $state ) {
