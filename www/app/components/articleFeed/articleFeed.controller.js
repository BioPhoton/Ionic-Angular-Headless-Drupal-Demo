;(function() {
	...
	angular.module('drupalionicDemo.articleFeed.controller',['ng-cordova', 'commons.directives.toggleByOwnUid',
	                                                         'ngDrupal7Services-3_x.resources.views', 'ngDrupal7Services-3_x.commons.authentication.service', 'ngDrupal7Services-3_x.commons.helperService','drupalionicDemo.articleFeed.service' ])
		...
		function deleteArticle(article, linstIndex) {
			...
			ArticleFeedService
				.deleteArticle(article)
					...
					.finally(function() {vm.deletingArticle = false;});
